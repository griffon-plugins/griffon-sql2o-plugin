...
----
dependencies {
    griffon '{project-group}:griffon-sql2o-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-sql2o-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{project-group}:griffon-sql2o-groovy-compile:{project-version}'
}
----

== Maven

First configure the `griffon-sql2o-plugin` BOM in your POM file, by placing the following
