...
public class Sql2oConnectEndEvent extends Event {
    ...
    public Sql2oConnectEndEvent(@Nonnull String name, @Nonnull Map<String, Object> config, @Nonnull Sql2o sql2o) {
    ...
    @Nonnull
    public static Sql2oConnectEndEvent of(@Nonnull String name, @Nonnull Map<String, Object> config, @Nonnull Sql2o sql2o) {
        return new Sql2oConnectEndEvent(name, config, sql2o);
    }
}
